...
hexo.extend.filter.register('after_generate', function() {
  ...
  setTimeout(function() {
    var cta = '<div style="background:#f8f9fa;border:1px solid #e9ecef;border-radius:8px;padding:20px 24px;margin:24px 0;text-align:center;">' +
      '<p style="margin:0 0 12px;font-size:16px;font-weight:600;color:#333;">📬 Get honest AI tool reviews in your inbox</p>' +
      '<p style="margin:0 0 16px;font-size:14px;color:#666;">No spam. No sponsored fluff. Just real tool reviews for solopreneurs.</p>' +
